                                             ...
                                             const bool zero_padding)
{
    ...
    for (int n = 0; n < batch/im2col_step_; ++n)
    {
        ...
        for (int g = 0; g < group; ++g)
        {
            ...
            std::cout << "weight_gm:" << std::endl;
            std::cout << weight_gm << std::endl;
            std::cout << "grad_output_gm:" << std::endl;
            std::cout << grad_output_gm << std::endl;
\
            columns_g.select(0, g) = at::mm(weight_gm, grad_output_gm);
        }
        // Turns out columns doesn't match
        std::cout << "weight_g:" << std::endl;
        std::cout << weight_g << std::endl;
        std::cout << "grad_output_g:" << std::endl;
        std::cout << grad_output_g << std::endl;
        ...
        std::cout << offset << std::endl;
        std::cout << "im2col_step_:" << std::endl;
        std::cout << im2col_step_ << std::endl;
        std::cout << "per_input_size:" << std::endl;
        std::cout << per_input_size << std::endl;
        std::cout << "per_offset_size:" << std::endl;
        std::cout << per_offset_size << std::endl;
        std::cout << "batch_n:" << std::endl;
        std::cout << batch_n << std::endl;
        ...
        std::cout << width << std::endl;
        std::cout << "height_out:" << std::endl;
        std::cout << height_out << std::endl;
        std::cout << "width_out:" << std::endl;
        std::cout << width_out << std::endl;
        ...
        std::cout << dilation_w << std::endl;
        std::cout << "deformable_group:" << std::endl;
        std::cout << deformable_group << std::endl;
        ...
        AT_DISPATCH_FLOATING_TYPES(input.type(), "deform_conv_backward_cuda", ([&] {
            ...
            std::cout << "after deformable_col2im_coord columns:" << std::endl;
            std::cout << columns << std::endl;
            ...
            std::cout << "after deformable_im2col_cuda columns:" << std::endl;
            std::cout << columns << std::endl;
