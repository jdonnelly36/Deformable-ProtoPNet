...
class DeformConv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels,
                 kernel_size, stride, padding, init_weight=None, dilation=1, groups=1, deformable_groups=1, im2col_step=64, bias=True):
        ...
        print("DEF GROUPS: ", self.deformable_groups)
...
class DeformConvPack(DeformConv):
    ...
    def __init__(self, in_channels, out_channels,
                 kernel_size, stride, padding, init_weight=None,
        ...
        super(DeformConvPack, self).__init__(in_channels, out_channels,
                                  kernel_size, stride, padding, init_weight, dilation, groups, deformable_groups, im2col_step, bias)
    ...
    def forward(self, input, offset=None):
        ...
        result = DeformConvFunction.apply(input, offset, 
                                          self.weight, 
                                          self.bias, 
                                          self.stride, 
                                          self.padding, 
